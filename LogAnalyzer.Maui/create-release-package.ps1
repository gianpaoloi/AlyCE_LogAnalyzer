...
Write-Host "  [OK] Created LogAnalyzer.Maui shortcut" -ForegroundColor Green
...
# Cleanup temporary staging directory after ZIP is created
Remove-Item -Path $packageDir -Recurse -Force

# Cleanup release build artifacts (bin/Release and obj/Release)
Write-Host ""
